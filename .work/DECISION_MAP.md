...
- release maintenance, backports, deprecation notice, private vulnerability reporting, security policy, schema-upgrade evidence: 0794
- Homebrew, cask, Chocolatey, stable releases, prerelease publication, Windows package verification: 0788 0790 0791
- doc site: code blocks, copying, Expressive Code, board, sandbox, versioning, voice, cookie, errors, links, avatars, profile, idle fade, personal text, scrolling speed, viewport width, page size, reference board, proposed pages only for user-facing features: 0581-0610 0651 0677 0679 0712 0721 0752 0756 0763 0764 0765 0769 0772 0773 0775 0776 0778 0782 0784 0795
